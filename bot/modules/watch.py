...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg += f"\n\nExample:\n<code>/{BotCommands.WatchCommand} https://youtu.be/Pk_TthHfLeE 720 |Mahmud</code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>Mahmud</b>"
